...
const GIT_REPOSITORIES_FULL_BASE_PATH_KEY = "GIT_REPOSITORIES_FULL_BASE_PATH"
const GIT_POSTGRESQL_USERNAME_KEY = "GIT_POSTGRESQL_USERNAME"
const GIT_POSTGRESQL_PASSWORD_KEY = "GIT_POSTGRESQL_PASSWORD"
const GIT_POSTGRESQL_DATABASE_NAME_KEY = "GIT_POSTGRESQL_DATABASE_NAME"
const GIT_POSTGRESQL_PORT_KEY = "GIT_POSTGRESQL_PORT"
const GIT_POSTGRESQL_HOST_KEY = "GIT_POSTGRESQL_HOST"

// CheckConfig checks if all required environment variables are set
func CheckConfig() error {
	// make an array of all required environment
